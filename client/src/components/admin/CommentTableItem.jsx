  ...
  return (
    <tr className='border-y border-gray-300'>
      <td className='px-6 py-4'>
        <b className='font-medium dark:text-gray-300'>Blog</b> : {blog.title}
        <br />
        <br />
        <b className='font-medium dark:text-gray-300'>Name</b> : {comment.name}
        <br />
        <b className='font-medium dark:text-gray-300'>Comment</b> : {comment.content}
      </td>
